...
export const BULSSI_DESCS = {
  ...
  // === 운명의 궁궐 (중) — 신규 불씨 (2026-05-22, 법보 전용) ===
  육봉진화: '[육봉진화 3개] 법보 피해 심화가 3.00%(1급)/4.50%(2급)/6.00%(3급) 증가한다.',
  환검현화: '[환검현화 3개/6개] 공격법보 시전 시, 입히는 피해가 무작위로 0~12%(1급)/0~18%(2급)/0~24%(3급) 증가한다.',
  중악첩화: '[중악첩화 3개/6개] 공격법보를 2개 시전할 때마다 다음번 법보 시전 시 입히는 피해가 24%(1급)/36%(2급)/48%(3급) 증가한다.',
  현어령화: '[현어령화 3개] 방어법보가 제공하는 호신강기 계수가 3.00%(1급)/4.50%(2급)/6.00%(3급) 증가한다.',
  열반륜화: '[열반륜화 3개] 방어법보 파괴 시 10초간 자신이 받는 피해가 4.00%(1급)/6.00%(2급)/8.00%(3급) 감소한다.',
};
...
export const TRIGGER_DESCS = {
  ...
  혼원마주: '🔮 혼원마주 (방어법보 파괴 시 발동, CD 160초). 적측 발동 시 해당 법보 복구 + 평균 보호막 회복 (무 90% / 허 60% / 진 76%). ⚠️ 너프 적용 2026-05-09 (이전: 110/60/93%).',
...
// 법보 설명 (인게임 원문 기준 — 정련 +140강, 제련 5성 수치 적용)
// 제련: 1성당 본 신통 진원 +10.4%, 5성 = +52% 누적
// 환음요탑/참원선검/오염혁선: 104.00% (0성 base) + 52% = 156.00%
// 유리옥호: 108.30% (0성 base) + 52% = 160.30%
// 진원 22억 기준 본체 = 22 × 1.56 + 10 = 44.32억 / 22 × 1.603 + 10 = 45.27억
// 라인 분리: ◆ 마커로 문단 구분 (whitespace-pre-line CSS 로 \n 보존)
export const TREASURE_DESCS = {
  환음요탑: `◆ 피해 상한: 3155.00억\n\n◆ 재사용 시간: 32초\n\n◆ 최대 진원의 15.00%를 소모하여 적군 1명에게 45.27억(160.30%의 최대 진원 + 10.00억)의 피해를 입히고, 호신강기에 28.74억(130.65%의 최대 진원)의 피해를 입힌다.\n\n◆ 대상이 보유한 법보 보호막 1개당, 해당 법보의 최종 피해가 15.00% 증가한다.`,
  참원선검: `◆ 피해 상한: 3155.00억\n\n◆ 재사용 시간: 32초\n\n◆ 최대 진원의 15.00%를 소모하여 적 1명에게 45.27억(최대 진원의 160.30% + 10.00억)의 피해를 입히고, 호신강기를 무시하여 생명에 추가로 12.83억(최대 공격력의 641.55%)의 피해를 가한다.\n\n◆ 해당 법보가 대상의 생명에 피해를 줄 때, 최종 피해가 5.00%~15.00% 증가하며, 대상의 현재 생명 비율이 낮을수록 피해가 증가한다.`,
  유리옥호: `◆ 피해 상한: 3155.00억\n\n◆ 재사용 시간: 32초\n\n◆ 최대 진원의 15.00%를 소모하여 적군 1명에게 45.27억(160.30%의 최대 진원 + 10.00억)의 피해를 입히고, 호신강기에 28.74억(130.65%의 최대 진원)의 피해를 입힌다.\n\n◆ 자신의 법보 치명타 확률이 30.00% 상승하며, 5초 지속된다. 해당 법보가 보호막을 보유한 대상에게 피해를 줄 경우, 해당 효과가 추가 15.00% 상승하며, 5초 지속된다.`,
  오염혁선: `◆ 피해 상한: 3155.00억\n\n◆ 재사용 시간: 32초\n\n◆ 최대 진원의 15.00%를 소모하여 적군 1명에게 45.27억(160.30%의 최대 진원 + 10.00억)의 피해를 입히고, 호신강기에 28.74억(130.65%의 최대 진원)의 피해를 입힌다.\n\n◆ 자신이 보호막에 가하는 피해 증가가 15.00% 상승하며, 8초 지속된다. 해당 법보가 대상의 법보 보호막을 파괴할 경우, 다음 법보 사용 시 반드시 치명타가 발동된다.`,
  산하옥척: `◆ 피해 상한: 3155.00억\n\n◆ 재사용 시간: 32초\n\n◆ 최대 진원의 15.00%를 소모하여 적군 1명에게 45.27억(160.30%의 최대 진원 + 10.00억)의 피해를 입히고, 호신강기에 28.74억(130.65%의 최대 진원)의 피해를 입힌다.\n\n◆ 해당 법보가 대상에게 피해를 줄 때, 대상의 다음 신통이 가하는 최종 피해가 25.00% 감소된다.`,
  경몽비파: `◆ 피해 상한: 3155.00억\n\n◆ 재사용 시간: 32초\n\n◆ 최대 진원의 15.00%를 소모하여 적군 1명에게 45.27억(160.30%의 최대 진원 + 10.00억)의 피해를 입히고, 호신강기에 28.74억(130.65%의 최대 진원)의 피해를 입힌다.\n\n◆ 신통 또는 법보를 사용할 때마다 음역 1중첩을 획득하며, 각 음역 중첩마다 해당 법보의 치명타 피해 배율이 12.00% 증가한다. 해당 법보가 피해를 주면 음역 중첩이 초기화된다.`,
};

// 사용자 진원/공격력 stat 기반 동적 법보 설명 생성
//   - 기본 TREASURE_DESCS 는 진원 22억 / 공격력 2억 기준 정적 텍스트 (default)
//   - makeTreasureDesc(name, base진원_억, baseATK_억) 호출 시 사용자 stat 기반 절대값으로 replace
//   - 본 피해 = 진원 × 160.30% + 10억 / 호신강기 추가 = 진원 × 130.65% / 참원선검 2타 = 공격력 × 641.55%
export function makeTreasureDesc(name, base진원_억, baseATK_억) {
  const desc = TREASURE_DESCS[name];
  if (!desc) return '';
  const j = (base진원_억 != null) ? base진원_억 : 22;
  const atk = (baseATK_억 != null) ? baseATK_억 : 2;
  const 본 = (j * 1.6030 + 10).toFixed(2);
  const 호신 = (j * 1.3065).toFixed(2);
  const 검호신무시 = (atk * 6.4155).toFixed(2);
  return desc
    .replace(/45\.27억/g, `${본}억`)
    .replace(/28\.74억/g, `${호신}억`)
    .replace(/12\.83억/g, `${검호신무시}억`);
}
...
const BISUL_DESCS = {
  ...
  '혼원·무': '혼원마주·무 — 방어법보 파괴 시 1법보 복구 + 호신강기 평균값의 90% (적측). ⚠️ 너프 2026-05-09 (이전 110%).',
  '혼원·허': '혼원마주·허 — 방어법보 파괴 시 1법보 복구 + 호신강기 평균의 60% + 12초간 신통/치명타 차단 +48%.',
  '혼원·진': '혼원마주·진 — 방어법보 파괴 시 1법보 복구 + 호신강기 평균의 76% + 모든 미파괴 효과 지속. ⚠️ 너프 2026-05-09 (이전 93%).',
