...
export const TREASURE_DESCS = {
  환음요탑: `${_STATUS}\n\n◆ 피해 상한: 3155.00억\n\n◆ 재사용 시간: 32초\n\n◆ 최대 진원의 15.00%를 소모하여 적군 1명에게 44.32억(156.00%의 최대 진원 + 10.00억)의 피해를 입히고, 호신강기에 28.74억(130.65%의 최대 진원)의 피해를 입힌다.\n\n◆ 대상이 보유한 법보 보호막 1개당, 해당 법보의 최종 피해가 15.00% 증가한다.`,
  참원선검: `${_STATUS}\n\n◆ 피해 상한: 3155.00억\n\n◆ 재사용 시간: 32초\n\n◆ 최대 진원의 15.00%를 소모하여 적 1명에게 44.32억(최대 진원의 156.00% + 10.00억)의 피해를 입히고, 호신강기를 무시하여 생명에 추가로 12.83억(최대 공격력의 641.55%)의 피해를 가한다.\n\n◆ 해당 법보가 대상의 생명에 피해를 줄 때, 최종 피해가 5.00%~15.00% 증가하며, 대상의 현재 생명 비율이 낮을수록 피해가 증가한다.`,
