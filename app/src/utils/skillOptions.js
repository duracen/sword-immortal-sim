...
export const TRIGGER_DESCS = {
  ...
  적난새: '🦅 적난새 (1급 새 · 20s 빙의). 빙의 중 자기 최종피해 +20%, 매 공격마다 불깃털 3-5개 (1개당 진원 3.5% 확정). 의념: 영혼 3중첩당 종료시 진원 7% 확정. 진령: 불깃털 +50%, 의념 발동 시 자기 최종피해 +4% (중첩).',
  ...
  업화마주: '🔮 업화마주 (5회 공격마다 / 진은 매 cast). · 무/허: 10s DoT (1tick = min(maxHP×1.5%/0.75%, atk×324%/162%) × 10회). · 진: 10s 멸신 상태 (15회 피해마다 광역 발동, max 10회).',
};
