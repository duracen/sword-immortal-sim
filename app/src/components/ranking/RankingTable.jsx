        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-slate-400 border-b border-slate-700">
              ...
              <th className="text-right py-2 px-2">41초<br/><span className="text-[10px] text-slate-400 font-normal">(1사이클)</span></th>
              <th className="text-right py-2 px-2">52초</th>
          ...
          <tbody>
            {list.map((r, i) => (
              ...
              >
                ...
                <td className={`py-2 px-2 text-right ${sortBy === '41' ? 'font-bold text-amber-300' : ''}`}>{formatKR(r.s41)}</td>
                <td className={`py-2 px-2 text-right ${sortBy === '52' ? 'font-bold text-amber-300' : ''}`}>{formatKR(r.s52)}</td>
        ...
        {list.map((r, i) => (
          ...
          >
            ...
            <div className="grid grid-cols-5 gap-1 mb-2">
              {[
                { lbl: '41초(1사이클)', v: r.s41, on: sortBy === '41' },
                { lbl: '52초', v: r.s52, on: sortBy === '52' },
