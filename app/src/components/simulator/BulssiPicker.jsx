      ...
      <div className="flex flex-wrap gap-2">
        {sets.map(({ key, choices, desc }) => (
          ...
          >
            ...
            {BULSSI_DESCS[key] && (
              <div className="hidden group-hover:block absolute left-0 top-full mt-1 z-[200] w-80 p-3 bg-slate-950 border border-pink-600 rounded-lg shadow-xl pointer-events-none">
