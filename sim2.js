...
const CFG = {
  ...
  baseHP: 10_000_000_000,  // 체력 100억
  baseShield: 3_000_000_000, // 호신강기 30억
  baseCR: 30,         // 기본 치명타율 (%)
  ...
  targetMaxHP: 13_000_000_000, // 100억 HP + 30억 호신강기
...
SK['균천·현봉'] = {
  ...
  cast(s, slots) {
    ...
    if (js >= 3) record(s, dealDamage(s, 140, { noSkillMult: true, type: '호무' }), '새벽빛(호무)');
    // [남월] 검세 5+ 시 천검 +80% 증폭 (max tier)
    if (js >= 5) 천검발동(s, slots, 80);
  }
};
SK['균천·파월'] = {
  fam: '균천', cat: '영검', main: 225,
